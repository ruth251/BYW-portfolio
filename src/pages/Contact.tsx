...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    { icon: <Phone className="h-6 w-6" />, title: "Phone Numbers", details: ["+251 91 250 7091", "+251 96 893 105"] },
    { icon: <Mail className="h-6 w-6" />, title: "Email Address", details: ["groupnosha@gmail.com"] },
    { icon: <Clock className="h-6 w-6" />, title: "Business Hours", details: ["Monday - Friday: 8:00 AM - 6:00 PM", "Saturday: 9:00 AM - 4:00 PM"] }
  ];

  const companies = [
    { name: "Welin", speciality: "Veterinary Drugs", contact: "agropharma10@gmail.com", phone: "+251 91 207 2531" },
    { name: "Bnosha", speciality: "Agricultural Inputs", contact: "sendfornosha@gmail.com", phone: "+251 91 250 7091" },
    { name: "Yabon", speciality: "Agrochemical", contact: "Sendyonas@gmail.com", phone: "+251 99 623 8648" }
  ];
